...
public class EnviromentCubemap implements Disposable{
    ...
    public EnviromentCubemap (Pixmap positiveX, Pixmap negativeX, Pixmap positiveY, Pixmap negativeY, Pixmap positiveZ, Pixmap negativeZ) {
    ...
    public EnviromentCubemap (FileHandle positiveX, FileHandle negativeX, FileHandle positiveY, FileHandle negativeY, FileHandle positiveZ, FileHandle negativeZ) {
    ...
    public EnviromentCubemap (Pixmap cubemap) {
    ...
    public EnviromentCubemap (FileHandle cubemap){
