...
public class UIBeforeGameContoller implements UIContoller {
    private Button restartButton;
    private Stage stage;
    private static UIBeforeGameContoller uiAfterGameController;
    ...
    public static UIBeforeGameContoller getInstance() {
        if (uiAfterGameController == null) {
            uiAfterGameController = new UIBeforeGameContoller();
        }
        return uiAfterGameController;
    }

    public static UIBeforeGameContoller removeInstanceAndAssignNew() {
